...
namespace SidePhotoViewer.Views
{
    public partial class ShellWindow : MetroWindow, IShellWindow, INotifyPropertyChanged
    {
        ...
        {
            new HamburgerMenuGlyphItem() { Label = Properties.Resources.ShellSSViewPage, Glyph = "\uE8A5", TargetPageType = typeof(SSViewPage) },
            new HamburgerMenuGlyphItem() { Label = Properties.Resources.ShellSSListPage, Glyph = "\uE8A5", TargetPageType = typeof(SSListPage) },
        };
